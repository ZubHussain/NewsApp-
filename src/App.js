      ...
      <div>
        ...
        <Navbar/>
          ...
          <Routes>
            ...
            <Route exact path="/general" element={<News key="entertainment" country="in" category="general"/>}/>
            <Route exact path="/health" element={<News key="entertainment" country="in" category="health"/>}/>
